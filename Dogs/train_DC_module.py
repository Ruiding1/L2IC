...
class Trainer(object):
    def __init__(self, output_dir):
        ...
        path = '/home/li/datasets/dogs/dog_ims'
        self.test_dataset = Dataset(data_dir=path, mode='test')
        ...
        if not cfg.TRAIN.FLAG:
            G = "../saved_models/dogs/netG.pth"
            D = "../saved_models/dogs/netD.pth"
