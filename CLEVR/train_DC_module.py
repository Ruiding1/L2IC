        ...
        for j in range(0,2):
            for temp in range(0, self.num_cls):
                ...
                for i in range(0, BATCH):
                    save_img_results(None, fake_final_img[i].detach().cpu(), z, i, self.image_dir, flage=0)
...
if __name__ == "__main__":
    ...
    # (2.4261079665754917, 0.018901311289635542)
    # eval finished 	 fid :  32.327
